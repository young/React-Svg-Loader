...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var SvgLoader = __webpack_require__(1);
	
	var Test = React.createClass({displayName: "Test",
		render: function() {
			return (React.createElement(SvgLoader, {fill: "#11E11E", url: "http://127.0.0.1:8080/foo.svg"}));
		}
	});
	
	
	React.render(React.createElement(Test, null), document.getElementById('bar'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SvgLoader = React.createClass({displayName: "SvgLoader",
	  ...
	  componentWillMount:function(p, s) {
	    this._getExternalSvg(this.props.url);
	  },
	  getInitialState:function() {
	    return {foo: undefined}
	  },
	  _getExternalSvg:function(url) {
	    request
	    .get(url)
